...
import com.capwin.launcher.core.StreamUtils;
...
public class LogView extends View {
    ...
    public static File getLogFile() {
        File parent = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS), "CapWin Launcher");
